...
import { getSalesinvoiceById } from 'apiSdk/salesinvoices';
import { SalesinvoiceInterface } from 'interfaces/salesinvoice';
import { SalesDetailListPage } from 'pages/sales-details';

function SalesinvoiceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('salesinvoice', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/salesinvoices/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Subtotal" text={data?.subtotal} />

                <FormListItem label="Vat" text={data?.vat} />
