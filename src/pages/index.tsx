  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of efficient field sales operations with Sales Management App - Your ultimate solution for managing, tracking, and optimizing your salesforce performance."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of efficient field sales operations with Sales Management App - Your ultimate solution for managing, tracking, and optimizing your salesforce performance.`}
            </Text>
            <Box
