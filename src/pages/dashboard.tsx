...
import { SalesinvoiceListPage as ShowCaseList } from 'pages/salesinvoices';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Salesinvoices
                </Text>
                <NextLink href={`salesinvoices`} passHref legacyBehavior>
                  <Button
